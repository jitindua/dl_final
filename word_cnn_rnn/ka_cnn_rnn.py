...
for i in xrange(folds):
    ...
    check_cb = keras.callbacks.ModelCheckpoint('checkpoints_2/' + file_name + '.{epoch:02d}-{val_acc:.2f}-{val_loss:.2f}.hdf5', period = 10)
    tb_cb = keras.callbacks.TensorBoard(log_dir='./logs_2', histogram_freq=10)
    ...
    for j in xrange(1):
        ...
        pickle.dump(his.history, open('his_'+str(i)+'-'+str(j)+'.pkl','wb'))
